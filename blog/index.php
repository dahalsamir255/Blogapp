        ...
        <?php
          ...
          foreach($bloginfo as $blog)
          {
            ...
            ?>
              ...
              <div class="card mt-1">
              <div class="card-body">
                <a href="blog.php?blogid=<?php echo $blog["blogid"];?>"><h5 class="card-title text-dark"><?php echo $blog["blogtitle"]?></h5></a>
                <?php
                 if($numberofcharacters > 200)
                 {
                    ...
                    ?>
                    <form method="get">
                      <a href="blog.php?blogid=<?php echo $blog["blogid"];?>">Read more</a>
                    </form>
                    <?php
                 }
                 else
              ...
              <button class="like-button" data-blog-id="<?php echo $blog_id; ?>">
                ...
                Likes: <span class="like-count"><?php echo $like_count ? $like_count : 0; ?></span>
            </button>
                </a>
